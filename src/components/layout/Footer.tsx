		...
		<footer className="w-full overflow-hidden rounded-2xl border-primary/20 border-t bg-background pt-20 pb-8">
			...
			>
				<div className="grid grid-cols-1 gap-12 md:grid-cols-12 lg:gap-8">
					{/* Brand Column */}
					<div className="col-span-1 flex flex-col gap-6 md:col-span-12 lg:col-span-4">
						<Link
						...
						{/* Social Icons */}
						<div className="mt-2 flex items-center gap-4 text-foreground/50">
							<a
					...
					<div className="col-span-1 flex flex-col gap-6 md:col-span-4 lg:col-span-2 lg:col-start-7">
						<h3 className="font-heading font-medium text-heading text-xl tracking-wide">
							Explore
						</h3>
						<div className="flex flex-col gap-4">
							<Link
								className="w-fit font-medium text-base text-foreground/70 transition-colors hover:text-primary"
								href="/"
							>
								Home
							</Link>
					...
					<div className="col-span-1 flex flex-col gap-6 md:col-span-4 lg:col-span-2">
						<h3 className="font-heading font-medium text-heading text-xl tracking-wide">
							Information
						</h3>
						<div className="flex flex-col gap-4">
